...
public class Myhandler extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<tbody>");
		out.println("<tr>");
		System.out.println(" Myhandler usertype::::"+usertype);
			...
			for (Map.Entry<String, Product> entry : hm2.entrySet()) {
				...
				if (product.getCategory().equals(makers)) {
					...
					if(usertype!=null && usertype.equals("Manager")) {
						...
						out.println("<button class=\"lbutton\"><a href=\"DeleteProduct?id=" + product.getId() + "&&category=" + product.getCategory()
					...
					out.println("<button class=\"lbutton\"><a href=\"ViewItem?id=" + product.getId() + "&&category=" + product.getCategory()
							+ "\" class=\"btnreview\" style=\"color:white\">View Product</a></button>");
					}
					out.println("</ul>");
				}
