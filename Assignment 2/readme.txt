...
1.For data analytics you need to download gson-2.3.1 jar.
...
3.Then goto 'C:\apache-tomcat-7.0.34\webapps\SmartPortables_2\WEB-INF\classes' folder and compile all
...
5.Go to browser and enter the 'http://localhost/SmartPortables_2/Home' url.
