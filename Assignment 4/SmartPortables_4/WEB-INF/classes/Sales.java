...
public class Sales extends HttpServlet {
	 ...
	 protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			showSalesList(request, response);
		}
		
		protected void showSalesList(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		        try
	                {         
	                response.setContentType("text/html");
			PrintWriter pw = response.getWriter();
			...
			if(!utility.isLoggedin()){
				...
				session.setAttribute("login_msg", "Please Login to view Sales.");
			...
			products = ms.checkSales();
				...
				pw.print("<h3 class='box-title' style='font-weight: bold;text-transform: uppercase'>Sales List</h3>");
				pw.print("</div>");
				...
				pw.print("</td>");
				pw.print("<td>");
				pw.print("<label><b>"+prod.getPrice()*prod.getQuantity()+"</b></label>");
				pw.print("</td>");
				pw.print("</tr>");
				count++;
		        }
