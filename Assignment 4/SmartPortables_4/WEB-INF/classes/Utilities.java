...
public class Utilities extends HttpServlet {
			...
			if (session.getAttribute("username") != null) {
				...
				if(usertype!=null) {
					if(usertype.equals("Manager")) {
						...
						result = result + "<li><a href=\"./ShowUpdateProduct\">Update Product</a></li>";
						result = result + "<li><a href=\"./ShowDeleteProduct\">Delete Product</a></li>";
			...
			if (session.getAttribute("username") != null) {
				...
				if(usertype!=null) {
					if(usertype.equals("Manager")) {
						...
						result = result + "<li>";
						result = result + "<h4>Manage Prodcts</h4>";
						result = result + "<ul>";
						result = result + "<li id=\"first\"><a href=\"./ShowAddProduct\">Add Product</a></li>";
						result = result + "<li><a href=\"./ShowUpdateProduct\">Update Product</a></li>";
						result = result + "<li><a href=\"./ShowDeleteProduct\">Delete Product</a></li>";
						result = result + "</ul>";
						result = result + "</li>";
	...
	public int getOrderPaymentSize(String username,String usertype) {
		...
		try {
			orderPayments = MySQLDataStoreUtilities.selectMaxOrderId();
		} catch (Exception e) {
			e.printStackTrace();
		}
		int size = 0;
		Integer maxKey=Collections.max(orderPayments.keySet());
	...
	public void updateProduct(String productname, String producttype, String productcondition, String productmaker,
			String productimage, String productquantity, String productprice, String productonsale,
			String productrebate,String prodid) {
		MySQLDataStoreUtilities.updateProduct(productname,producttype,productcondition,productmaker,
        		productimage,productquantity,productprice,productonsale,productrebate,prodid);
		
	}

	public int deleteProduct(String productid) {
		int result=0;
		result=MySQLDataStoreUtilities.deleteProduct(productid);
		return result;
	}
}