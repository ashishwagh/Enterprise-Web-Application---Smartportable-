...
3.Then goto 'C:\apache-tomcat-7.0.34\webapps\SmartPortables_4\WEB-INF\classes' folder and compile all
...
5.Go to browser and enter the 'http://localhost/SmartPortables_4/Home' url.
